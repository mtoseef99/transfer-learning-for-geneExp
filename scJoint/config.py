...
class Config(object):
    def __init__(self):
        ...
        print("LR for stage 1:", self.lr_stage1)
        print("LR for stage 3:", self.lr_stage3)
        print("LR for epochs decay:", self.lr_decay_epoch)
        print("Epochs for stage 1:", self.epochs_stage1)
        print("Epochs for stage 3:", self.epochs_stage3)
        print("==============================")
